...
//      fun(currentPage);
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        appendStr+="<li style='border: solid thin #DDDDDD;margin: 5px;'>共"+pageCount+"页</li>";
       return appendStr;
...
function change(all){
	$("#args").removeAttr("page-data");
	var vtiao=$('#tiao').val();
	if(vtiao>all){
		vtiao=all;
	}
	if(vtiao==''||vtiao<1){
		$("#args").attr("page-data",'1');
	}else{
		$("#args").attr("page-data",vtiao);
	}
}